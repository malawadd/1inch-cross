...
const SepoliaTrueERC20 = new Address('0xa54BEb6ace728320a2BAcf117d3320a01B20394c')
const MonadTrueERC20 = new Address('0xB11011307e0F3c805387c10aa69F874244b1bec3')
...
const SEPOLIA_ESCROW_FACTORY_ADDRESS = new Address(
    '0x922798bed51e498fa17bc1e5ec9946c1303db4a7'
)
const MONAD_ESCROW_FACTORY_ADDRESS = new Address(
    '0xee4050219b4c09909f47705c90847f957ea7fb70'
)
...
const SEPOLIA_ESCROW_SRC_IMPLEMENTATION_ADDRESS = new Address(
    '0xc20F7daB26b77265f3b4C68e3A7380E261ADA1ec'
)
const SEPOLIA_ESCROW_DST_IMPLEMENTATION_ADDRESS = new Address(
    '0x0AE5B5bCa6774efaC5110dfE690bcb3afA8B81B3'
)
const MONAD_ESCROW_SRC_IMPLEMENTATION_ADDRESS = new Address(
    '0xBFb1288b4Bb316c9A4E431c3D73aB38c508023D5'
)
const MONAD_ESCROW_DST_IMPLEMENTATION_ADDRESS = new Address(
    '0x6db0D5E60f723F0b94fD7d809265630B9beBDC7d'
)
...
export const ESCROW_SRC_IMPLEMENTATION = {
    ...
    [NetworkEnum.SEPOLIA]: SEPOLIA_ESCROW_SRC_IMPLEMENTATION_ADDRESS, // Sepolia
    [NetworkEnum.MONAD]: MONAD_ESCROW_SRC_IMPLEMENTATION_ADDRESS // Monadtestnet
}
...
export const ESCROW_DST_IMPLEMENTATION = {
    ...
    [NetworkEnum.SEPOLIA]: SEPOLIA_ESCROW_DST_IMPLEMENTATION_ADDRESS, // Sepolia
    [NetworkEnum.MONAD]: MONAD_ESCROW_DST_IMPLEMENTATION_ADDRESS // Monadtestnet
}
...
export const ESCROW_FACTORY = {
    ...
    [NetworkEnum.SEPOLIA]: SEPOLIA_ESCROW_FACTORY_ADDRESS, // Sepolia
    [NetworkEnum.MONAD]: MONAD_ESCROW_FACTORY_ADDRESS // Monadtestnet
}
